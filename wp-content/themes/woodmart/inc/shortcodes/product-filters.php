...
if ( ! function_exists( 'woodmart_product_filters_shortcode' ) ) {
	function woodmart_product_filters_shortcode( $atts, $content ) {
		...
		$output = '<form action="' . wc_get_page_permalink( 'shop' ) . '" class="woodmart-product-filters' . esc_attr( $classes ) . '" method="GET">';
...
if ( ! function_exists( 'woodmart_filters_categories_shortcode' ) ) {
	function woodmart_filters_categories_shortcode( $atts, $content ) {
		...
		echo '<div class="woodmart-pf-checkboxes woodmart-pf-categories">';
			...
			echo '<div class="woodmart-pf-dropdown woodmart-scroll">';
				echo '<ul class="woodmart-scroll-content">';
...
if ( ! function_exists( 'woodmart_filters_price_slider_shortcode' ) ) {
	function woodmart_filters_price_slider_shortcode( $atts, $content ) {
		...
		echo '<div class="woodmart-pf-checkboxes woodmart-pf-price-range multi_select widget_price_filter">
				<div class="woodmart-pf-title"><span class="title-text">' . esc_html( $title ) . '</span><ul class="woodmart-pf-results"></ul></div>
