		...
		if( function_exists( 'register_sidebar' ) ) {
			...
			register_sidebar( 
				array(
					...
					'class'         => '',
					'before_widget' => '<div id="%1$s" class="woodmart-widget widget header-widget %2$s">',
					'after_widget'  => '</div>',
					'before_title'  => '<h5 class="widget-title">',
					'after_title'   => '</h5>'
				)
				...
				foreach ( $footer_config['cols'] as $key => $columns ) {
					...
					register_sidebar( 
						array(
							...
							'class'         => '',
							'before_widget' => '<div id="%1$s" class="woodmart-widget widget footer-widget %2$s">',
							'after_widget'  => '</div>',
							'before_title'  => '<h5 class="widget-title">',
							'after_title'   => '</h5>'
						)
	...
	function woodmart_register_required_plugins() {
	    ...
	    $plugins = array(
	        ...
	        array(
	            ...
	            'version'            => '5.5.2', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
	        ...
	        array(
	            ...
	            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
	            'version'            => '1.0.9', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
	            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
	            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
	            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
	        ),
