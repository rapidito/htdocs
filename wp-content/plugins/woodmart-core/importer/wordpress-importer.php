...
<?php
	...
	function process_menu_item( $item ) {
		...
		} else if ( 'post_type' == $_menu_item_type && isset( $custom_processed_posts[intval($_menu_item_object_id)] ) ) {
			$_menu_item_object_id = $custom_processed_posts[intval($_menu_item_object_id)];
